...
/* --- HMI button (PA3, EXTI3) with debounce --------------------------------*/
            ...
            switch(current_event) {
                ...
                case EVENT_BARO_READY:
                {
                    ...
                    if (baro_read_ok) {
                        ...
                        /* Clamp: over a ~120 m / ~12 s drop the real lapse-rate effect is
                           well under 1 m — anything larger is sensor noise, not a correction. */
