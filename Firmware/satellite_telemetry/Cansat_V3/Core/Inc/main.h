...
/* Private defines -----------------------------------------------------------*/
#define HMIBTN_EXTI13_Pin GPIO_PIN_13
#define HMIBTN_EXTI13_GPIO_Port GPIOC
#define HMIBTN_EXTI13_EXTI_IRQn EXTI15_10_IRQn
...
#define VBAT_ADC1_IN12_Pin GPIO_PIN_1
#define VBAT_ADC1_IN12_GPIO_Port GPIOB
