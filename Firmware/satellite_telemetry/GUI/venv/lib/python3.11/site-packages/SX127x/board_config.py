...
class BOARD:
    ...
    RST  = 21   ### ADDED: Pin de Reset (Branche RST du LoRa sur GPIO 21 / Pin 40)
    ...
    def setup():
        ...
        GPIO.setup(BOARD.RST, GPIO.OUT) ### ADDED
        GPIO.output(BOARD.LED, 0)

        # Procédure de Reset physique au démarrage
        GPIO.output(BOARD.RST, 0)       ### ADDED
        time.sleep(.01)                 ### ADDED
        GPIO.output(BOARD.RST, 1)       ### ADDED
        time.sleep(.01)                 ### ADDED
